<template>
  <div class="demo">
    ...
    <hr/>
    <el-row>
      <el-button type="primary" @click="fetchList" :loading="loading">fetchList github</el-button>
      <el-table
        :data="tableData"
        style="width: 100%">
        <el-table-column
    ...
    <hr/>
    <el-button @click="fetchList2" :loading="loading2">fetchList gouren</el-button>
    <el-table
      :data="tableData2"
      style="width: 100%">
      <el-table-column
